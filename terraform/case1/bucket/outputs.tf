...
output "program_script_name"{
    value =  "${google_storage_bucket_object.program_script.bucket}/${google_storage_bucket_object.program_script.name}"
}

output "faculty_script_name"{
    value =  "${google_storage_bucket_object.faculty_script.bucket}/${google_storage_bucket_object.faculty_script.name}"
}
