...
func main() {
	...
	//print result
	totalLabs := responseJson.LabsAsigned + responseJson.MobileLabsAssigned
	...
	`, request.ProgramName, request.Semester, *request.Classrooms, *request.Labs,
		responseJson.ClassroomsAsigned, totalLabs, responseJson.MobileLabsAssigned, responseJson.Status, since)
